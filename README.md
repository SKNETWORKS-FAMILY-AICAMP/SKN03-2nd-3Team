...
##### 성은님과 종식님 의견: 코로나19로 인해 소비가 위축되었다가 이후 팬데믹 상황이 완화되면서 소비가 급증하는 경향이 나타났기에. 코로나19의 영향을 배제하고 분석하는 것이 어렵다. 이러한 코로나19와 같은 외부 요인이 소비 패턴에 미치는 영향이 지나치게 크기 때문에, 단순한 회귀 분석만으로는 정확한 결론을 도출하기 어려울 것 같다.
