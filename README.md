...
- 60대 시니어의 가계지출액은 전체 소비지출액 평균에 비해 낮다. <br>
- 50대 시니어의 가계지출액은 전체 소비지출액 평균을 상회한다.
<br>
...
---
# 😮‍💨 7. 오류 + 아쉬웠던 점들 😮‍💨
- AWS 연결 이슈 : 도커 이미지를 불러오지 못해 웹 접속시 화면이 뜨지 않았음 - 햐결: 도커 생성 파일 문제를 수정하여 코드빌드와 코드 파이프라인에 성공적으로 적용되었다.
